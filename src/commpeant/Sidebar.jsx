        ...
        <div className="main-menu menu-fixed menu-light menu-accordion menu-shadow"
            ...
            <div className="main-menu-content">
                <ul className="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                    ...
                    <li className="nav-item">
                        <Link to="/termsconditions" className="d-flex align-items-center" data-i18n="Terms&conditions">
                            <i className="material-symbols-outlined">phonelink_lock</i>
                            <span className="menu-title text-truncate" data-i18n="Termsconditions">
                                Terms&conditions
                            </span>
                        </Link>
                    </li>
                    <li className="nav-item">
                        <Link to="/privacy" className="d-flex align-items-center" data-i18n="privacy">
